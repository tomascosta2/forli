...
<section class="py-[90px] bg-[#231F20]">
	<div class="max-w-[1260px] mx-auto px-4">
		<div class="grid grid-cols-1 md:grid-cols-9 gap-[60px]">
			...
			<div class="banner2-list md:col-span-5 flex items-center text-white text-[20px] font-semibold">
...
<section class="py-[100px]" id="clientes">
	<div class="max-w-[1260px] mx-auto px-4">
		<div class="grid grid-cols-1 md:grid-cols-2 md:gap-12">
			...
			<img class="-order-1 md:order-none" src="<?php echo $clientes_fields['cliente_destacado']['url']; ?>" alt="<?php echo $clientes_fields['cliente_destacado']['alt']; ?>">
		</div>
	</div>
</section>
